...
void test_all_pieces_all_rotations() {
  ...
  for (int i = 0; i < 7; i++) {
    ...
    tetris.print();
    std::cout<<"count squares"<<tetris.count_squares()<<std::endl;
    std::cout<<"the score"<<(i+1)*4*4<<std::endl;
...
void additional_student_tests() {
  ...
  //========================================================
  // t.print();
  // t.remove_right_column();
  // t.remove_left_column();
  // t.add_right_column();
  // t.add_left_column();
  // t.print();
  // t.destroy();
